...
export function DatePicker ({ placeholder, setDate, value }) {
  ...
  return (
    <div className="w-[17rem]   relative bg-[#e7e9ee] border border-[#d7d7d7] py-5 gap-2 flex justify-center items-center rounded-md">
        <input type="hidden" name="date"/>
        <div className="gap-2 flex justify-center items-center cursor-pointer" onClick={toggleDatepicker}>
            <div>
                <p className="text-sm text-[#969cb2]">{placeholder}</p>
            </div>
            <div>
                <input
                    type="text"
                    readOnly
                    className="w-24 leading-none focus:outline-none text-[#969CB2] bg-[#e7e9ee]"
