...
export function TableHeader ({ 
    ...
    return (
        <div className="w-full md:relative absolute bottom-0 left-0">
            ...
            <div className="md:hidden flex justify-between items-center px-10 bg-brand">
                <button 
                    className="text-zinc-100 flex"
                    onClick={() => toggleDrawer()}
                >
                    <Faders size={36} weight="fill" />
                </button>
                <button 
                    className="bg-brand absolute -top-8 mx-auto left-[39%] text-center ring-8 ring-white sm:text-base text-sm p-4 rounded-full hover:bg-[#118B3A] transition-colors" 
                    onClick={handleNewTransactionClick}
                >
